<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/vendors/css/extensions/unslider.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/vendors/css/weather-icons/climacons.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/fonts/meteocons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/vendors/css/charts/morris.css')}}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/fonts/simple-line-icons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('backend/app-assets/css/pages/timeline.css')}}">
<link href="{{ url('public/backend/app-assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css') }}" rel="stylesheet" type="text/css">
