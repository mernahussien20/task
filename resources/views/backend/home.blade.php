                        ...
                        <div id="recent-buyers" class="media-list height-300 position-relative">
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-7.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-away avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-8.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                                <div class="media-body w-100">
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-busy avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-9.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                                <div class="media-body w-100">
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-10.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                                <div class="media-body w-100">
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-11.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                                <div class="media-body w-100">
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <div class="avatar avatar-away avatar-md"><img class="media-object rounded-circle" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-12.png')}}" alt="Generic placeholder image">
                                        <i></i>
                                    </div>
                                </div>
                                <div class="media-body w-100">
        ...
        {{-- <div class="row match-height">
                                        ...
                                        <ol>
                                                ...
                                                <blockquote class="blockquote border-0">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <img class="media-object img-xl mr-1" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-5.png')}}" alt="Generic placeholder image">
                                                        </div>
                                            ...
                                            <li data-date="28/02/2015">
                                                <blockquote class="blockquote border-0">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <img class="media-object img-xl mr-1" src="{{url('backend/app-assets/images/portrait/small/avatar-s-6.png')}}" alt="Generic placeholder image">
                                                        </div>
                                                        <div class="media-body">
                                                            Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        </div>
                                            ...
                                            <li data-date="20/04/2015">
                                                <blockquote class="blockquote border-0">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <img class="media-object img-xl mr-1" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-7.png')}}" alt="Generic placeholder image">
                                                        </div>
                                                        <div class="media-body">
                                                            Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        </div>
                                            ...
                                            <li data-date="20/05/2015">
                                                <blockquote class="blockquote border-0">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <img class="media-object img-xl mr-1" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-8.png')}}" alt="Generic placeholder image">
                                                        </div>
                                                        <div class="media-body">
                                                            Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        </div>
                                            ...
                                            <li data-date="09/07/2015">
                                                <blockquote class="blockquote border-0">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <img class="media-object img-xl mr-1" src="{{url('public/backend/app-assets/images/portrait/small/avatar-s-9.png')}}" alt="Generic placeholder image">
                                                        </div>
                                                        <div class="media-body">
                                                            Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        </div>
            ...
            <div class="col-xl-4 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <img class="img-fluid" src="{{url('public/backend/app-assets/images/carousel/06.jpg')}}" alt="Card image cap">
                        <div class="card-body">
